<%@ Page Title="" Language="VB" MasterPageFile="~/Options/OptionsMasterPage.master" AutoEventWireup="false" CodeFile="AddThreshold.aspx.vb" Inherits="Options_AddThreshold" %>
         ...
         <table class='StaticTable' style='width: 100%'><thead><tr><th>Add Threshold</th></tr></thead><tr><td>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              ...
              <tr>
                  ...
                  <td>
                      <asp:Button ID="ReturnButton" runat="server" CssClass="Button" PostBackUrl="~/Options/Thresholds/Default.aspx" Text="Return" UseSubmitBehavior="False" />&nbsp;<asp:Button ID="AddButton" runat="server" CssClass="Button" Text="Add Threshold" />
                                </td>
              </tr>

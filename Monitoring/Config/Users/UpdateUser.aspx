<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UpdateUser.aspx.vb" Inherits="Options_UpdateProfile"  UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <h2><asp:HyperLink ID="OptionsHyperLink" runat="server" NavigateUrl="~/Config/Default.aspx">Configuration</asp:HyperLink>&gt;<asp:HyperLink ID="UsersHyperLink" runat="server" NavigateUrl="~/Config/Users/">Users</asp:HyperLink>&gt;Update User</h2>

        <table class='StaticTable' style='width: 400px'><thead><tr><th>Update User</th></tr></thead><tr><td>

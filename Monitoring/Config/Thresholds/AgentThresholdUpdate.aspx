<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AgentThresholdUpdate.aspx.vb" Inherits="Config_Thresholds_AgentThresholdUpdate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

       <h2><asp:HyperLink ID="ConfigHyperLink" runat="server" NavigateUrl="~/Config/Default.aspx">Configuration</asp:HyperLink>&gt;Agent Configuration&gt;Update Threshold</h2>
<br />
         ...
         <table class='StaticTable' style='width: 450px'><thead><tr><th>Update Threshold</th></tr></thead><tr><td>
          <table style="width:500px">
              ...
              <tr>
                  ...
                  <td>
                      <asp:Button ID="ReturnButton" runat="server" CssClass="Button" PostBackUrl="~/Config/" Text="Return" UseSubmitBehavior="False" />&nbsp;<asp:Button ID="EditButton" runat="server" CssClass="Button" Text="Edit" />
                                </td>
              </tr>

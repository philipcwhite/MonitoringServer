<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AgentThresholdAdd.aspx.vb" Inherits="Config_Thresholds_AgentThresholdAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <h2><asp:HyperLink ID="ConfigHyperLink" runat="server" NavigateUrl="~/Config/Default.aspx">Configuration</asp:HyperLink>&gt;Agent Threshold&gt;Add Threshold</h2>
    <br />
         <table class='StaticTable' style='width: 450px'><thead><tr><th>Add Threshold</th></tr></thead><tr><td>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
                     ...
                     <asp:Label ID="hostnameLabel" runat="server" Text="Label" Visible="false"></asp:Label>

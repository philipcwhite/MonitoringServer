...
Partial Class Options_GlobalThresholds
    ...
    Private Sub BuildTable()
        ...
        For Each i In Q
            ...
            EditButton.PostBackUrl = "~/Config/Thresholds/GlobalThresholdsUpdate.aspx?ThresholdID=" & i.ThresholdID

            Dim DeleteButton As New Button
            DeleteButton.Text = "Delete"
            DeleteButton.CssClass = "Button"
            DeleteButton.ID = i.ThresholdID
            DeleteButton.PostBackUrl = "~/Config/Thresholds/GlobalConfirmation.aspx?ThresholdID=" & i.ThresholdID
    ...
    Protected Sub RestoreButton_Click(sender As Object, e As EventArgs) Handles RestoreButton.Click
        ...
        Response.Redirect("~/Config/Thresholds/GlobalConfirmation.aspx?ResetThresholds=True")

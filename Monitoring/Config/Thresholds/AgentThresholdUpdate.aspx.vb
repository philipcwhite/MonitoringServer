...
Partial Class Config_Thresholds_AgentThresholdUpdate
    ...
    Private Sub Config_Thresholds_AgentThresholdUpdate_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Config_Thresholds_AgentThresholdUpdate_PreLoad(sender As Object, e As EventArgs) Handles Me.PreLoad
